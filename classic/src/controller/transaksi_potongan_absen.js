Ext.define('Admin.controller.transaksi_potongan_absen', {
    extend: 'Ext.app.Controller',

    models: ['transaksi_potongan_absen.edit'],

    views: ['webdesktop.transaksi_potongan_absen.edit', 'webdesktop.transaksi_potongan_absen.header', 'webdesktop.transaksi_potongan_absen.detail', 'webdesktop.transaksi_potongan_absen.tombol'],
    
    refs: [{
        ref: 'transaksi_potongan_absenlist',
        selector: 'transaksi_potongan_absenlist'
    }],
        ...
        Ext.MessageBox.confirm('Konfirmasi', 'Yakin untuk proses simpan data?', function(btn,text) {
            if(btn=='yes') {
                ...
                transaksipotonganabsenedit.down('form').getForm().submit({
                    ...
                    method:'POST',
                    url: 'api/store/transaksi_potongan_absen/save.php',
                    waitMsg: 'Simpan...',
