Ext.define('Admin.view.bayarpembelian.BayarPembelianEdit', {
        ...
        items: [{
                ...
                items: [{
                    ...
                    listeners: {
                        specialkey: function(field, e) {
                            if (e.getKey() == e.ENTER) {
                                var me = this.up('kasbankkeluar-edit');
            ...
            }, 
            {
                ...
                store: Ext.create('Ext.data.Store', {
                    ...
                    data: [
                        {id: 1, tipe: 'K', kode: 'BKK', nama: 'Kas (BKK)'},
                        {id: 2, tipe: 'B', kode: 'BBK', nama: 'Bank (BBK)'}
                    ]
                }),
                valueField: 'kode',
                displayField: 'nama',
            ...
            },
            {
                ...
                listeners: {
                    specialkey: function(field, e) {
                        if (e.getKey() == e.ENTER) {
                            var me = this.up('bayarpembelian-edit');
    ...
    setNobukti: function(kode) {
        ...
        Ext.Ajax.request({
            method:'GET',
            url: './server/public/bayarpembelian/getnobukti',
            params: {
                tipe: kode
            },
