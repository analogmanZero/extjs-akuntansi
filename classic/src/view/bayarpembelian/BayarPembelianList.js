Ext.define('Admin.view.bayarpembelian.BayarPembelianList', {
    ...
    constructor: function(c) {
        ...
        var dataStore = Ext.create('Ext.data.Store', {
            model: 'Admin.model.kasbankkeluar.KasBankKeluar',
            pageSize: 25,
            proxy: {
                type: 'ajax',
                url: './server/public/bayarpembelian',
                reader: {
                    type: 'json',
                    rootProperty: 'data'
                },
                    ...
                    },
                    {
                        ...
                        store: Ext.create('Ext.data.Store', {
                            ...
                            data: [
                                ...
                                {id: 2, tipe: 'K', kode: 'BKK', nama: 'Transaksi Kas (BKK)'},
                                {id: 3, tipe: 'B', kode: 'BBK', nama: 'Transaksi Bank (BBK)'}
                            ]
                        }),
                        value: tipe,
                        valueField: 'kode',
