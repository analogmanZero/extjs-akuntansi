Ext.define('Admin.view.kasbankkeluar.EditDetail', {
    extend: 'Ext.grid.Panel',
    xtype: 'kasbankkeluar-edit-detail',

    cls: 'kasbankkeluar-grid',
    constructor: function(c) {
        ...
        Ext.apply(c, {
            ...
            columns: [
                ...
                //--- [1]
                {xtype: 'gridcolumn', cls: 'content-column', text: 'Akun Debet', flex: 0.7, menuDisabled: true, sortable: false, align: 'left', dataIndex: 'detail_akun', 
                    editor: {
                        xtype: 'combobox',
                        store: {
                            type: 'akun-level-4'
    ...
    getJumlah: function() {
        ...
        setTimeout(function() {
            ...
            var qty    = me.columns[3].getEditor(record).getSubmitValue();
            var harga  = me.columns[4].getEditor(record).getSubmitValue();

            me.columns[5].getEditor(record).setValue(qty*harga);
        }, 10);                                    
    },
    ...
    getTotal: function() {
        ...
        me.up('kasbankkeluar-edit').down('#total').setValue(total);
    },
