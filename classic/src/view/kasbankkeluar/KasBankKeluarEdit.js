Ext.define('Admin.view.kasbankkeluar.KasBankKeluarEdit', {
        ...
        items: [{
            ...
            }, 
            {
                ...
                store: Ext.create('Ext.data.Store', {
                    ...
                    data: [
                        {id: 1, tipe: 'K', kode: 'BKK', nama: 'Bukti Kas Keluar (BKK)'},
                        {id: 2, tipe: 'B', kode: 'BBK', nama: 'Bukti Bank Keluar (BBK)'}
                    ]
                }),
                valueField: 'kode',
                displayField: 'nama',
    ...
    setNobukti: function(kode) {
        ...
        Ext.Ajax.request({
            method:'GET',
            url: './server/public/kasbankkeluar/getnobukti',
            params: {
                tipe: kode
            },
