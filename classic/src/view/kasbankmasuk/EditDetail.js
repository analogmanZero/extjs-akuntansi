Ext.define('Admin.view.kasbankmasuk.EditDetail', {
    extend: 'Ext.grid.Panel',
    xtype: 'kasbankmasuk-edit-detail',
    ...
    constructor: function(c) {
        ...
        Ext.apply(c, {
            ...
            columns: [
                ...
                //--- [1]
                {xtype: 'gridcolumn', cls: 'content-column', text: 'Akun Kredit', flex: 0.7, menuDisabled: true, sortable: false, align: 'left', dataIndex: 'detail_akun', 
                    editor: {
                        xtype: 'combobox',
                        store: {
                            type: 'akun-level-4'
    ...
    getTotal: function() {
        ...
        me.up('kasbankmasuk-edit').down('#total').setValue(total);
    },
