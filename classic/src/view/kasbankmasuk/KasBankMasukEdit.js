Ext.define('Admin.view.kasbankmasuk.KasBankMasukEdit', {
        ...
        items: [{
            ...
            }, 
            {
                ...
                store: Ext.create('Ext.data.Store', {
                    ...
                    data: [
                        {id: 1, tipe: 'K', kode: 'BKM', nama: 'Bukti Kas Masuk (BKM)'},
                        {id: 2, tipe: 'B', kode: 'BBM', nama: 'Bukti Bank Masuk (BBM)'}
                    ]
                }),
                valueField: 'kode',
                displayField: 'nama',
    ...
    setNobukti: function(kode) {
        ...
        Ext.Ajax.request({
            method:'GET',
            url: './server/public/kasbankmasuk/getnobukti',
            params: {
                tipe: kode
            },
