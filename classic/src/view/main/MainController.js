Ext.define('Admin.view.main.MainController', {
    ...
    onGoOnTop: function() {
        ...
        wrapContainer.setScrollY(0);
        //console.log(wrapContainer.getScrollY());
    },
    ...
    setCurrentView: function(hashTag) {
        ...
        var defpage = !user?'login':'page404';
        ...
        if(menu) {
            ...
            treelist.getStore().setRoot(data);
        }
        ...
        var me = this,
            ...
            view = (node && node.get('viewType')) || defpage,
    ...
    onButtonLogout: function () {
        Ext.Msg.confirm('Logout', 'Yakin untuk keluar?',
                        this.onButtonLogoutConfirmed, this);
    },
