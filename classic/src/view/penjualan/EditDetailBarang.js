Ext.define('Admin.view.penjualan.EditDetailBarang', {
    extend: 'Ext.grid.Panel',
    xtype: 'penjualan-edit-detail-barang',
    ...
    getSubTotalJumlah: function() {
        ...
        //STORE JASA
        var editDetailJasa = me.up('penjualan-edit').down('penjualan-edit-detail-jasa');
        var storeDetailJasa = editDetailJasa.getStore();   
        for(var row=0;row<storeDetailJasa.getCount(); row++) {
            var rec = storeDetailJasa.getAt(row);
