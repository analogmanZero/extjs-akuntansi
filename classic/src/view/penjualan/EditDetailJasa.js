Ext.define('Admin.view.penjualan.EditDetailJasa', {
    extend: 'Ext.grid.Panel',
    xtype: 'penjualan-edit-detail-jasa',
    ...
    constructor: function(c) {
        ...
        var jasaSelect = function(f, record) {
            var store = me.getStore();
        ...
        Ext.apply(c, {
            ...
            columns: [
                ...
                //--- [1]
                {xtype: 'gridcolumn', cls: 'content-column', text: 'Item Jasa', flex: 1.5, menuDisabled: true, sortable: false, align: 'left', dataIndex: 'nama_barang', 
                    editor: {
                        xtype: 'combobox',
                        store: {
                            type: 'jasa'
    ...
    getSubTotalJumlah: function() {
        ...
        //STORE BARANG
        var editDetailBarang = me.up('penjualan-edit').down('penjualan-edit-detail-barang');
        var storeDetailBarang = editDetailBarang.getStore();   
        for(var row=0;row<storeDetailBarang.getCount(); row++) {
            var rec = storeDetailBarang.getAt(row);
