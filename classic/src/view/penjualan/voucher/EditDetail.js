Ext.define('Admin.view.penjualan.voucher.EditDetail', {
    extend: 'Ext.grid.Panel',
    xtype: 'penjualan-voucher-edit-detail',

    cls: 'penjualan-voucher-grid',
    constructor: function(c) {
        ...
        var voucherSelect = function(f, record) {
            var store = me.getStore();
        ...
        Ext.apply(c, {
            ...
            columns: [
                ...
                //--- [1]
                {xtype: 'gridcolumn', cls: 'content-column', text: 'Voucher', flex: 1.5, menuDisabled: true, sortable: false, align: 'left', dataIndex: 'nama_barang', 
                    editor: {
                        xtype: 'combobox',
                        store: {
                            type: 'voucher'
