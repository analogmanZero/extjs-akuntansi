Ext.define('Admin.view.webdesktop.gajiprorate.rapel', {

    extend: 'Ext.grid.Panel',
    alias : 'widget.gajiproraterapel',
    ...
    constructor: function(c) {
        ...
        me.store = Ext.create('Admin.store.stores', {
            fields: ['id', 'nik', 'nama', 'area', 'keterangan', {name: 'jumlah', type: 'float'}],
            url: 'api/store/gajiprorate/rapelStore.php',
            proxy: {
                type: 'memory',
                reader: {
                    type: 'json',
                        ...
                        listeners: {
                            specialkey: function(field, e){
                                ...
                                if (e.getKey() == e.ENTER) {
                                    ...
                                    Ext.Ajax.request({
                                        url: 'api/store/gajiprorate/saveRapel.php',
                                        method: 'POST',
                                        params:{
                                            ...
                                            jumlah: me.columns[5].getEditor(me.recordSelected).getSubmitValue()
                                        },
    ...
    hapusRecord: function() {
        ...
        if (selection) {           
            Ext.Ajax.request({
                url: 'api/store/gajiprorate/deleteRapel.php',
                method: 'POST',
                params:{
                    id: selection.get('id')                    
                },
