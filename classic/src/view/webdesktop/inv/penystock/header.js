Ext.define('Admin.view.webdesktop.inv.penystock.header', {

    extend: 'Ext.panel.Panel',
    alias : 'widget.invpenystockheader',
                            ...
                            keydown: {
                                ...
                                fn: function (eventObject, htmlElement, object, options) {
                                    if (eventObject.keyCode == 13) {
                                        setTimeout(function(){
                                            var grid = me.up('invpenystockedit').down('invpenystockdetail');
                                            if(grid.getStore().getCount()>0) {
                                                grid.rowEditor.startEdit(0, 1);
                                                grid.columns[1].getEditor(grid.recordSelected).focus(true, 10);
                                            } else {
                                                var tambah =  me.up('invpenystockedit').down('#tambah');
