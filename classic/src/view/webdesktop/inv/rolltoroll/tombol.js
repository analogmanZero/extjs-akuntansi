Ext.define('Admin.view.webdesktop.inv.rolltoroll.tombol', {
    
    extend: 'Ext.panel.Panel',
    alias : 'widget.invrolltorolltombol',
    ...
    transaksiBaru: function() {
        ...
        this.down('#draft').setReadOnly(false);
    ...
    disabledButton: function(value) {
        ...
        this.down('#draft').setReadOnly(value);
    },
    ...
    suksesSimpan: function() {
        ...
        this.down('#draft').setReadOnly(true);
