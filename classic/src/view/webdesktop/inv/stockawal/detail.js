Ext.define('Admin.view.webdesktop.inv.stockawal.detail', {

    extend: 'Ext.grid.Panel',
    alias : 'widget.invstockawaldetail',
    ...
    constructor: function(c) {
        ...
        Ext.apply(c, {
            ...
            store: Ext.create('Admin.store.stores', {
                fields: ['id', 'kode_barang', 'nama_barang', 'bentuk', 'noroll', 'substance', 'size', 'ukuran_potong', 'qty', 'satuan', 'harga', {name: 'jumlah', type: 'float'}, 'status'],
                proxy: {
                    type: 'memory',
                    reader: {
                        type: 'json',
            ...
            columns: [
                ...
                //--- [3]
                {sortable: false, text: 'No. Roll / ID', dataIndex: 'noroll', align: 'left', flex: 0.8, menuDisabled: true,
                    editor: {
                        xtype: 'textfield',
                        msgTarget: 'side',
                        vtype: 'noroll',
               ...
               {sortable: false, text: 'Ukuran Potong', dataIndex: 'ukuran_potong', align: 'right', flex: 0.8, menuDisabled: true,
                ...
                //--- [11]
                {sortable: false, text: 'Status', dataIndex: 'status', align: 'left', flex: 0.6, menuDisabled: true,
                    editor: {
                        xtype: 'combobox',
                        selectOnFocus: true,
                        store: Ext.create('Ext.data.Store', {
