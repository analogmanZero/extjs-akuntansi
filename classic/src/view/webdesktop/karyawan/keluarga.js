Ext.define('Admin.view.webdesktop.karyawan.keluarga', {

    extend: 'Ext.grid.Panel',
    alias : 'widget.karyawankeluarga',
    ...
    constructor: function(c) {
        ...
        Ext.apply(c, {
            ...
            store: Ext.create('Admin.store.stores', {
                fields: ['id', 'nama', 'hub_keluarga', 'jenis_kelamin', 'tgl_lahir', 'tanggal_lahir', 'gol_darah'],
                proxy: {
                    type: 'memory',
                    reader: {
                        type: 'json',
            ...
            columns: [
                ...
                //--- [2]
                {sortable: false, text: 'Hub. Keluarga', dataIndex: 'hub_keluarga', align: 'left', flex: 0.5, menuDisabled: true,
                    editor: {
                        xtype: 'combobox',
                        msgTarget: 'side',
                        queryMode: 'local',
                        store: Ext.create('Ext.data.Store', {
                            fields: ['nama'],
                            data:[{nama: 'Suami'}, {nama: 'Istri'}, {nama: 'Anak'}]
                        }),
                        valueField: 'nama',
                        displayField: 'nama',
                        typeAhead: true,                        
                ...
                //--- [3]
                {sortable: false, text: 'L/P', dataIndex: 'jenis_kelamin', align: 'center', flex: 0.5, menuDisabled: true, 
                    editor: {
                        xtype: 'combobox',
                        msgTarget: 'side',
                        queryMode: 'local',
                        store: Ext.create('Ext.data.Store', {
                            fields: ['nama'],
                            data:[{nama: 'Laki-laki'}, {nama: 'Perempuan'}]
                        }),
                        valueField: 'nama',
                        displayField: 'nama',
                        typeAhead: true,                        
                ...
                //--- [5]
                {sortable: false, text: 'Gol. Darah', dataIndex: 'gol_darah', align: 'center', flex: 0.5, menuDisabled: true,
                    editor: {
                        xtype: 'textfield',
                        fieldStyle: 'text-align: center;',
                        listeners: {
    ...
    getDetail: function() {
        ...
        for(var row =0;row<me.getStore().getCount();row++) {
            ...
            str += (str!=''?'\n':'') +                                      // id  keterangan
                   ...
                   (rec.data['jenis_kelamin']=="Laki-laki"?"L":(rec.data['jenis_kelamin']=="Perempuan"?"P":"")) + '\t' +                       //  3  jenis_kelamin
                   rec.data['tgl_lahir'] + '\t' +                           //  4  tanggal_lahir
                   rec.data['gol_darah'];                                   //  5  gol_darah
       }
