Ext.define('Admin.view.webdesktop.karyawan.kerabat', {

    extend: 'Ext.grid.Panel',
    alias : 'widget.karyawankerabat',
    ...
    constructor: function(c) {
        ...
        Ext.apply(c, {
            ...
            store: Ext.create('Admin.store.stores', {
                fields: ['id', 'nama', 'hub_kerabat', 'telepon', 'alamat'],
                proxy: {
                    type: 'memory',
                    reader: {
                        type: 'json',
            ...
            columns: [
                ...
                //--- [2]
                {sortable: false, text: 'Hub. Kerabat', dataIndex: 'hub_kerabat', align: 'left', flex: 0.5, menuDisabled: true,
                    editor: {
                        xtype: 'textfield',
                        listeners: {
                            specialkey: function(field, e){
                ...
                //--- [3]
                {sortable: false, text: 'No. Telepon', dataIndex: 'telepon', align: 'left', flex: 0.5, menuDisabled: true, 
                    editor: {
                        xtype: 'textfield',
                        listeners: {
                            specialkey: function(field, e){
    ...
    getDetail: function() {
        ...
        for(var row =0;row<me.getStore().getCount();row++) {
            ...
            str += (str!=''?'\n':'') +                                      // id  keterangan
                   ...
                   rec.data['hub_kerabat'] + '\t' +                         //  2  hub_kerabat
                   rec.data['telepon'] + '\t' +                             //  3  telepon
                   rec.data['alamat'];                                      //  4  alamat
       }
