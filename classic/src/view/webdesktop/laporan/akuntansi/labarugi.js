Ext.define('Admin.view.webdesktop.laporan.akuntansi.labarugi', {

    extend: 'Ext.window.Window',
    alias : 'widget.laporanakuntansilabarugi',
        ...
        Ext.apply(c, {
            items: [{
                ...
                buttons: [{
                    text: 'Excel',
                    handler: function(b) {
                        var reportFileName = 'accounting/labarugi.jrxml';
                        ...
                        Ext.Ajax.request({
                            ...
                            success: function(response) {
                                ...
                                if(json['success']) {
                                    ...
                                    'labarugi', 'width=715, height=565, toolbar=no, menubar=no, sccorebars=yes');
                                    myMask.hide();
                                } else {
                                    myMask.hide();
                                    Ext.MessageBox.show({
