Ext.define('Admin.view.webdesktop.laporan.akuntansi.neraca', {

    extend: 'Ext.window.Window',
    alias : 'widget.laporanakuntansineraca',
        ...
        Ext.apply(c, {
            items: [{
                ...
                buttons: [{
                    text: 'Excel',
                    handler: function(b) {
                        var reportFileName = 'accounting/neraca.jrxml';
                        ...
                        Ext.Ajax.request({
                            ...
                            success: function(response) {
                                ...
                                if(json['success']) {
                                    ...
                                    'neraca', 'width=715, height=565, toolbar=no, menubar=no, sccorebars=yes');
                                    myMask.hide();
                                } else {
                                    myMask.hide();
                                    Ext.MessageBox.show({
