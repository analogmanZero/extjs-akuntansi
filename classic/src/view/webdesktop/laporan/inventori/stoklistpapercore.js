Ext.define('Admin.view.webdesktop.laporan.inventori.stoklistpapercore', {

    extend: 'Ext.grid.Panel',
    alias : 'widget.laporaninventoristoklistpapercore',
    ...
    constructor: function(c) {
        ...
        var reportFileName = 'inventori/stoklistpapercore.jrxml';
            ...
            items:[{
                ...
                handler: function(b) {
                    ...
                    window.open('api/store/cetakLaporan.php?filename=' + reportFileName + tag,
                            'lapstoklistpapercore', 'width=715, height=565, toolbar=no, menubar=no, sccorebars=yes');

//                    var myMask = new Ext.LoadMask({target: me, msg:'Cetak...'});
//                    myMask.show();
//                    proxy.extraParams['cabang'] = me.up('window').down('#cabang').submitValue;
//
//                    Ext.Ajax.request({
//                        method:'POST',
//                        url: 'api/store/javaReport.php?namafile='+reportFileName+'&tipe='+reportTipe,
//
...
//                    });
        ...
        var store = Ext.create('Admin.store.stores', {
            ...
            url: 'api/store/laporan/inventori/stoklistpapercoreStore.php'
        });
