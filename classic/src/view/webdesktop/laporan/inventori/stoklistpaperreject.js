Ext.define('Admin.view.webdesktop.laporan.inventori.stoklistpaperreject', {

    extend: 'Ext.grid.Panel',
    alias : 'widget.laporaninventoristoklistpaperreject',
    ...
    constructor: function(c) {
        ...
        var reportFileName = 'inventori/stoklistpaperreject.jrxml';
            ...
            items:[{
                ...
                handler: function(b) {
                    ...
                    window.open('api/store/cetakLaporan.php?filename=' + reportFileName + tag,
                            'lapstoklistpaperpaparreject', 'width=715, height=565, toolbar=no, menubar=no, screjectbars=yes');
                }
            }]
        }];
        ...
        var store = Ext.create('Admin.store.stores', {
            ...
            url: 'api/store/laporan/inventori/stoklistpaperrejectStore.php'
        });
        ...
        Ext.apply(c, {
            ...
            columns: [
                ...
                {text: 'Unit (Lembar)', dataIndex: 'satuan', flex: 0.5, align: 'right', renderer: rendererDecimal, summaryRenderer: summaryRendereBall},
