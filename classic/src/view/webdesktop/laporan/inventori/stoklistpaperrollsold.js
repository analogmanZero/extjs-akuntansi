Ext.define('Admin.view.webdesktop.laporan.inventori.stoklistpaperrollsold', {

    extend: 'Ext.grid.Panel',
    alias : 'widget.laporaninventoristoklistpaperrollsold',
    ...
    constructor: function(c) {
        ...
        var reportFileName = 'inventori/stoklistpaperrollsold.jrxml';
            ...
            items:[{
                ...
                handler: function(b) {
                    ...
                    window.open('api/store/cetakLaporan.php?filename=' + reportFileName + tag,
                        'lapstoklistpaperrolsold', 'width=715, height=565, toolbar=no, menubar=no, scrollbars=yes');
                }
            }]
        }];

        var store = Ext.create('Admin.store.stores', {
            fields: ['tanggal', 'noroll', 'grade', 'substance', 'size', 'ukuran_potong', 'weight', 'satuan', 'customer', 'sumber', 'noref'],
            url: 'api/store/laporan/inventori/stoklistpaperrollsoldStore.php'
        });
        ...
        Ext.apply(c, {
            ...
            columns: [
                ...
                //{text: 'Unit', dataIndex: 'satuan', flex: 0.5, align: 'right', renderer: rendererDecimal, summaryRenderer: summaryRendererRoll},
                {text: 'Customer', dataIndex: 'customer', flex: 1, align: 'left'},
                //{text: 'Sumber', dataIndex: 'sumber', flex: 0.4, align: 'center'},
                {text: 'No. Trx', dataIndex: 'noref', flex: 0.4, align: 'left'}
            ],
