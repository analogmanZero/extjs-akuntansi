Ext.define('Admin.view.webdesktop.laporan.inventori.stoklistpaperwasted', {

    extend: 'Ext.grid.Panel',
    alias : 'widget.laporaninventoristoklistpaperwasted',
    ...
    constructor: function(c) {
        ...
        var reportFileName = 'inventori/stoklistpaperwaste.jrxml';
            ...
            items:[{
                ...
                handler: function(b) {
                    ...
                    window.open('api/store/cetakLaporan.php?filename=' + reportFileName + tag,
                            'lapstoklistpaperwasted', 'width=715, height=565, toolbar=no, menubar=no, scwastedbars=yes');
                }
            }]
        }];
        ...
        var store = Ext.create('Admin.store.stores', {
            ...
            url: 'api/store/laporan/inventori/stoklistpaperwastedStore.php'
        });
        ...
        Ext.apply(c, {
            ...
            columns: [
                ...
                //{text: 'Unit (Ball)', dataIndex: 'satuan', flex: 0.5, align: 'right', renderer: rendererDecimal, summaryRenderer: summaryRendereBall},
