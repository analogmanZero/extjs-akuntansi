Ext.define('Admin.view.webdesktop.laporan.payroll.bayargaji', {

    extend: 'Ext.window.Window',
    alias : 'widget.laporanpayrollbayargaji',
            ...
            items: [{
                ...
                buttons: [{
                    ...
                    handler: function(b) {
                        ...
                        var reportFileName = 'payroll/PembayaranGaji.jrxml';
                        ...
                        window.location = 'api/store/laporan/payroll/report_data.php?nik='+nik+'&periode='+periode+'&nama='+nama+'&project='+project;
                        ...
                        Ext.Ajax.request({
                            ...
                            success: function(response) {
                                ...
                                if(json['success']) {
                                    ...
                                    'bayargaji', 'width=715, height=565, toolbar=no, menubar=no, sccorebars=yes');
                                    myMask.hide();
                                } else {
                                    myMask.hide();
                                    Ext.MessageBox.show({
