Ext.define('Admin.view.webdesktop.laporan.payroll.lemburmigas', {

    extend: 'Ext.window.Window',
    alias : 'widget.laporanpayrolllemburmigas',
            ...
            items: [{
                ...
                items:[{
                   xtype: 'monthfield',
                    ...
                    store: Ext.create('Ext.data.Store', {
                        fields: ['id', 'nama'],
                        data:[
                            {id: 1, nama: 'Lembur Reguler'},
                            {id: 2, nama: 'Lembur PH'},
                            {id: 3, nama: 'Lembur Backup'}
                        ]
                    }),
                    valueField: 'id',
                    displayField: 'nama',
                ...
                buttons: [{
                    ...
                    handler: function(b) {
                        ...
                        var reportFileName = tipe==1?'payroll/LemburRegulerMigasExcel.jrxml':(tipe==2?'payroll/LemburPHMigas.jrxml':'payroll/LemburBackupMigas.jrxml');
                    ...
                    handler: function(b) {
                        ...
                        var tipe = me.down('[name=tipe]').getSubmitValue();
                        var jenis = me.down('[name=jenis]').getSubmitValue();
                        var reportFileName = tipe==1?'payroll/LemburRegulerMigas.jrxml':(tipe==2?'payroll/LemburPHMigas.jrxml':'payroll/LemburBackupMigas.jrxml');
                        var nik      = jenis==2?me.down('[name=nik]').getSubmitValue():'0';
                        var nama     = jenis==3?me.down('[name=nama]').getSubmitValue():'';
                        var project  = jenis==4?me.down('[name=project]').getSubmitValue():'';
                        //var umur     = jenis==5?me.down('[name=umur]').getSubmitValue():'';
                        ...
                        Ext.Ajax.request({
                            ...
                            success: function(response) {
                                ...
                                if(json['success']) {
                                    ...
                                    'lemburmigas', 'width=715, height=565, toolbar=no, menubar=no, sccorebars=yes');
                                    myMask.hide();
                                } else {
                                    myMask.hide();
                                    Ext.MessageBox.show({
