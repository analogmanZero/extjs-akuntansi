Ext.define('Admin.view.webdesktop.laporan.payroll.lemburretail', {

    extend: 'Ext.window.Window',
    alias : 'widget.laporanpayrolllemburretail',
            ...
            items: [{
                ...
                items:[{
                   xtype: 'monthfield',
                    ...
                    store: Ext.create('Ext.data.Store', {
                        fields: ['id', 'nama'],
                        data:[
                            {id: 1, nama: 'Lembur Backup'},
                            {id: 2, nama: 'Lembur PH'},
                            {id: 3, nama: 'Lembur SPL'}
                        ]
                    }),
                    valueField: 'id',
                    displayField: 'nama',
                ...
                buttons: [{
                    ...
                    handler: function(b) {
                        ...
                        var reportFileName = tipe==1?'payroll/LemburBackup.jrxml':(tipe==2?'payroll/LemburPH.jrxml':'payroll/LemburSAdmin.jrxml');
                        ...
                        Ext.Ajax.request({
                            ...
                            success: function(response) {
                                ...
                                if(json['success']) {
                                    ...
                                    'lemburretail', 'width=715, height=565, toolbar=no, menubar=no, sccorebars=yes');
                                    myMask.hide();
                                } else {
                                    myMask.hide();
                                    Ext.MessageBox.show({
