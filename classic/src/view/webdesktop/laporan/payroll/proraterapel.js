Ext.define('Admin.view.webdesktop.laporan.payroll.proraterapel', {

    extend: 'Ext.window.Window',
    alias : 'widget.laporanpayrollproraterapel',
            ...
            items: [{
                ...
                items:[{
                   xtype: 'monthfield',
                    ...
                    store: Ext.create('Ext.data.Store', {
                        fields: ['id', 'nama'],
                        data:[
                            {id: 1, nama: 'Daftar Gaji Prorate'},
                            {id: 2, nama: 'Detail Gaji Rapel'}
                        ]
                    }),
                    valueField: 'id',
                    displayField: 'nama',
                ...
                buttons: [{
                    ...
                    handler: function(b) {
                        ...
                        var reportFileName = tipe==1?'payroll/GajiProrate.jrxml':'payroll/GajiRapel.jrxml';
                        ...
                        Ext.Ajax.request({
                            ...
                            success: function(response) {
                                ...
                                if(json['success']) {
                                    ...
                                    'proraterapel', 'width=715, height=565, toolbar=no, menubar=no, sccorebars=yes');
                                    myMask.hide();
                                } else {
                                    myMask.hide();
                                    Ext.MessageBox.show({
