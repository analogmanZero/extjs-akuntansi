Ext.define('Admin.view.webdesktop.laporan.payroll.uanghadir', {

    extend: 'Ext.window.Window',
    alias : 'widget.laporanpayrolluanghadir',
            ...
            items: [{
                ...
                buttons: [{
                    ...
                    handler: function(b) {
                        ...
                        var reportFileName = 'payroll/UangHadir.jrxml';
                        ...
                        Ext.Ajax.request({
                            ...
                            success: function(response) {
                                ...
                                if(json['success']) {
                                    ...
                                    'uanghadir', 'width=715, height=565, toolbar=no, menubar=no, sccorebars=yes');
                                    myMask.hide();
                                } else {
                                    myMask.hide();
                                    Ext.MessageBox.show({
