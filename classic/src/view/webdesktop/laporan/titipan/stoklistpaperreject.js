Ext.define('Admin.view.webdesktop.laporan.titipan.stoklistpaperreject', {

    extend: 'Ext.grid.Panel',
    alias : 'widget.laporantitipanstoklistpaperreject',
    ...
    constructor: function(c) {
        ...
        var reportFileName = 'titipan/stoklistpaperreject.jrxml';
            ...
            items:[{
                ...
                handler: function(b) {
                    ...
                    window.open('api/store/cetakLaporan.php?filename=' + reportFileName + tag,
                            'lapstoklistpaperpaparrejecttitipan', 'width=715, height=565, toolbar=no, menubar=no, screjectbars=yes');
                }
            }]
        }];
        ...
        var store = Ext.create('Admin.store.stores', {
            ...
            url: 'api/store/laporan/titipan/stoklistpaperrejectStore.php'
        });
