Ext.define('Admin.view.webdesktop.laporan.titipan.stoklistpaperroll', {

    extend: 'Ext.grid.Panel',
    alias : 'widget.laporantitipanstoklistpaperroll',
    ...
    constructor: function(c) {
        ...
        var reportFileName = 'titipan/stoklistpaperroll.jrxml';
            ...
            items:[{
                ...
                handler: function(b) {
                    ...
                    window.open('api/store/cetakLaporan.php?filename=' + reportFileName + tag,
                        'lapstoklistpaperrolltitipan', 'width=715, height=565, toolbar=no, menubar=no, scrollbars=yes');
                }
            }]
        }];

        var store = Ext.create('Admin.store.stores', {
            fields: ['tanggal', 'noroll', 'grade', 'substance', 'size', 'weight', 'satuan', 'customer', 'noref'],
            url: 'api/store/laporan/titipan/stoklistpaperrollStore.php'
        });
