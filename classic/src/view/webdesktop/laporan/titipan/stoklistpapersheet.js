Ext.define('Admin.view.webdesktop.laporan.titipan.stoklistpapersheet', {

    extend: 'Ext.grid.Panel',
    alias : 'widget.laporantitipanstoklistpapersheet',
    ...
    constructor: function(c) {
        ...
        var reportFileName = 'titipan/stoklistpapersheet.jrxml';
            ...
            items:[{
                ...
                handler: function(b) {
                    ...
                    window.open('api/store/cetakLaporan.php?filename=' + reportFileName + tag,
                            'lapstoklistpapersheettitipan', 'width=715, height=565, toolbar=no, menubar=no, scsheetbars=yes');
                }
            }]
        }];
        ...
        var store = Ext.create('Admin.store.stores', {
            ...
            url: 'api/store/laporan/titipan/stoklistpapersheetStore.php'
        });
