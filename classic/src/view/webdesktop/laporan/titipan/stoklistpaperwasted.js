Ext.define('Admin.view.webdesktop.laporan.titipan.stoklistpaperwasted', {

    extend: 'Ext.grid.Panel',
    alias : 'widget.laporantitipanstoklistpaperwasted',
    ...
    constructor: function(c) {
        ...
        var reportFileName = 'titipan/stoklistpaperwaste.jrxml';
            ...
            items:[{
                ...
                handler: function(b) {
                    ...
                    window.open('api/store/cetakLaporan.php?filename=' + reportFileName + tag,
                            'lapstoklistpaperwastedtitipan', 'width=715, height=565, toolbar=no, menubar=no, scwastedbars=yes');
                }
            }]
        }];
        ...
        var store = Ext.create('Admin.store.stores', {
            ...
            url: 'api/store/laporan/titipan/stoklistpaperwastedStore.php'
        });
