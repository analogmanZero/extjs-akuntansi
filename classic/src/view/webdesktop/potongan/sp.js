Ext.define('Admin.view.webdesktop.potongan.sp', {

    extend: 'Ext.grid.Panel',
    alias : 'widget.potongansp',
    ...
    constructor: function(c) {
        ...
        me.store = Ext.create('Admin.store.stores', {
            ...
            url: 'api/store/potongan/spStore.php',
            proxy: {
                type: 'memory',
                reader: {
                    type: 'json',
                ...
                {sortable: false, text: 'Jenis', dataIndex: 'jenis', align: 'left', width: 100, menuDisabled: true,
                    editor: {
                        ...
                        store: Ext.create('Ext.data.Store', {
                            fields: ['nama'],
                            data:[{nama: 'SP 1'}, {nama: 'SP 2'}, {nama: 'SP 3'}]
                        }),
                        valueField: 'nama',
                        displayField: 'nama',
                        listeners: {
                        ...
                        listeners: {
                            specialkey: function(field, e){
                                ...
                                if (e.getKey() == e.ENTER) {
                                    ...
                                    Ext.Ajax.request({
                                        url: 'api/store/potongan/spSave.php',
                                        method: 'POST',
                                        params:{
    ...
    hapusRecord: function() {
        ...
        if (selection) {           
            Ext.MessageBox.confirm('Konfirmasi', 'Yakin untuk hapus data yang dipilih?', function(btn,text) {
                if(btn=='yes') {
                    Ext.Ajax.request({
                        url: 'api/store/potongan/spDelete.php',
                        method: 'POST',
                        params:{
                            id: selection.get('id')                    
                        },
