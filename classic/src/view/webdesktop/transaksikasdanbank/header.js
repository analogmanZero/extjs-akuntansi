Ext.define('Admin.view.webdesktop.transaksikasdanbank.header', {

    extend: 'Ext.panel.Panel',
    alias : 'widget.transaksikasdanbankheader',
                    ...
                    items: [{
                        ...
                        listeners: {
                            ...
                            select: function(c) {
                                ...
                                var grid = me.up('window').down('transaksikasdanbankdetail');
                                grid.headerCt.getGridColumns()[1].setText((value=='BKM' || value=='BBM')?'Kredit':'Debet');
                                    ...
                                    if (eventObject.keyCode == 9) {
                                        setTimeout(function(){
                                            ...
                                            if(grid.getStore().getCount()>0) {
                                                ...
                                                var tambah =  me.up('transaksikasdanbankedit').down('#tambah');
