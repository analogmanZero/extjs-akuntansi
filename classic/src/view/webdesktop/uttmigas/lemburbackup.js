Ext.define('Admin.view.webdesktop.uttmigas.lemburbackup', {

    extend: 'Ext.grid.Panel',
    alias : 'widget.uttmigaslemburbackup',
    ...
    constructor: function(c) {
        ...
        me.store = Ext.create('Admin.store.stores', {
            ...
            url: 'api/store/uttmigas/lemburbackupStore.php',
            proxy: {
                type: 'memory',
                reader: {
                    type: 'json',
                        ...
                        listeners: {
                            specialkey: function(field, e){
                                ...
                                if (e.getKey() == e.ENTER) {
                                    //proses seve disini
                                    var jenis = 'BACKUP';
                                    var jam   = me.columns[6].getEditor(me.recordSelected).getSubmitValue();
                                    var pecah = [0, 0, 0];
                                    ...
                                    Ext.Ajax.request({
                                        url: 'api/store/uttmigas/lemburbackupSave.php',
                                        method: 'POST',
                                        params:{
                                            ...
                                            dua: pecah[1],
                                            tiga: pecah[2],
                                            total: me.columns[7].getEditor(me.recordSelected).getSubmitValue(),
    ...
    hapusRecord: function() {
        ...
        if (selection) {
            Ext.MessageBox.confirm('Konfirmasi', 'Yakin untuk hapus data yang dipilih?', function(btn,text) {
                if(btn=='yes') {
                    Ext.Ajax.request({
                        url: 'api/store/uttmigas/lemburbackupDelete.php',
                        method: 'POST',
                        params:{
                            id: selection.get('id')                    
                        },
    ...
    getJumlah: function() {
        ...
        setTimeout(function() {
            ...
            me.columns[7].getEditor(me.recordSelected).setValue(total);
            me.columns[8].getEditor(me.recordSelected).setValue(Math.floor(eval(nilai)*eval(total)));
