Ext.define('Admin.view.webdesktop.uttmigas.lemburph', {

    extend: 'Ext.grid.Panel',
    alias : 'widget.uttmigaslemburph',
    ...
    constructor: function(c) {
        ...
        me.store = Ext.create('Admin.store.stores', {
            ...
            url: 'api/store/uttmigas/lemburphStore.php',
            proxy: {
                type: 'memory',
                reader: {
                    type: 'json',
                        ...
                        listeners: {
                            specialkey: function(field, e){
                                ...
                                if (e.getKey() == e.ENTER) {
                                    ...
                                    Ext.Ajax.request({
                                        url: 'api/store/uttmigas/lemburphSave.php',
                                        method: 'POST',
                                        params:{
    ...
    hapusRecord: function() {
        ...
        if (selection) {
            Ext.MessageBox.confirm('Konfirmasi', 'Yakin untuk hapus data yang dipilih?', function(btn,text) {
                if(btn=='yes') {
                    Ext.Ajax.request({
                        url: 'api/store/uttmigas/lemburphDelete.php',
                        method: 'POST',
                        params:{
                            id: selection.get('id')                    
                        },
