...
class KasBankKeluar extends BaseController
{
	use ResponseTrait;
    ...
    public function delete($trx_id) {
		...
		if($delete) {
			$response = [
				'success' => true,
				'message' => 'Hapus bukti kas & bank keluar berhasil.'
			];
			...
			$response = [
				'success' => false,
				'message' => 'Proses hapus bukti kas & bank keluar gagal.'
			];
    ...
    public function insert() {
		...
		$response = [
			'success' => true,
			'message' => 'Tambah bukti kas & bank keluar berhasil.'
		];
		return $this->respond($response, 200);
	}
	...
	public function update($trx_id) {
		...
		$response = [
			'success' => true,
			'message' => 'Update bukti kas & bank keluar berhasil.'
		];
		return $this->respond($response, 200);
	}
}
